...
namespace ProtoBuf
{
    ...
    {
        private sealed class FastReadOnlySequenceProtoReader : ProtoReader
        {
            public FastReadOnlySequenceProtoReader() : base()
            {
            }
            ...
            public override void Dispose()
            {
                base.Dispose();
                _source = default;
                Pool<FastReadOnlySequenceProtoReader>.Put(this);
            }
            ...
            private protected override int ImplTryReadUInt64VarintWithoutMoving(ref State state, out ulong value)
            {
                ...
                static int ViaStackAlloc(FastReadOnlySequenceProtoReader reader, ref State s, out ulong val)
                {
